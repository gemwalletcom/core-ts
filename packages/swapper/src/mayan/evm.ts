...
export function buildEvmQuoteData(request: QuoteRequest, routeData: MayanQuote): QuoteData {
    ...
    const swapData = getSwapFromEvmTxPayload(routeData, request.from_address, request.to_address, { solana: request.referral_address }, request.from_address, signerChainId, null, null);
